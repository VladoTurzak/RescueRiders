// Rescue Riders — 16:9 (1280x720). Transparent canvas + HTML bg-cover.
// Desktop + mobile (joystick z index.html posiela šípky). Stabilné odomknutie zvuku.
...
const config = {
  ...
  width: GAME_WIDTH,
  height: GAME_HEIGHT,
  transparent: true,                         // BG rieši iba <img id="bg-cover">
...
function preload(){
  // Intro / fail / reward – 16:9 nové súbory
...
function missionComplete(){
  ...
  if(this.currentMission < MISSIONS.length-1){
    ...
    this.sound.stopAll(); playLoop(this,'game_complete',{loop:true,volume:0.7});
